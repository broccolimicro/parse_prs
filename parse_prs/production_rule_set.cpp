...
production_rule_set::production_rule_set(tokenizer &tokens, std::any data)
{
	debug_name = "prs_production_rule_set";
	parse(tokens, data);
}
...
void production_rule_set::parse(tokenizer &tokens, std::any data)
{
...
bool production_rule_set::is_next(tokenizer &tokens, int i, std::any data)
{
